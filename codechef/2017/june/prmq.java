...
//        final BufferedReader br = new BufferedReader(new FileReader(args[0]));
        ...
        //System.out.println("printing nodemap @ pos inside range query....");
//        HashMap<Integer, Integer> mergedHashMap = facNode.mergeIt(fArr[0].nodeMap, fArr[2].nodeMap, 3, 5);
//        System.out.println("post merging.....");
//        for (int key: mergedHashMap.keySet()){
//            System.out.print(key+":"+mergedHashMap.get(key)+"  ");
//        }
//        int sum = mergedHashMap.values().stream().mapToInt(Integer::intValue).sum();
        ////////// END OF THE WORLD
